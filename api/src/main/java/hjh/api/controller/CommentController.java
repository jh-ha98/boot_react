...
public class CommentController {
  ...
  public ResponseEntity<MessageBox<CommentInfo>> commentUpdate(HttpServletRequest request,
      @PathVariable("commentId") Long commentId, @RequestBody @Validated CommentUpdateForm form,
